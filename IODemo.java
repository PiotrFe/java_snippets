...
public class IODemo {
    public static void main(String[] args) throws FileNotFoundException, IOException {
        ...
        // ** FilterInputStream & FilterOutputStream --> wrappers around underlying
        // input
        // and output streams providing extended level of functionality; no new methods;
        // abstract methods which can be extended
        // ** BufferedInputStream & BufferedOutputStream --> allow to read and write
        // bigger
        // chunks of data (not only single bytes); good for optimization
        // ** PushbackInputStream --> allows to return read data back to the stream
        // ** SequenceInputStream --> allows to concatenate multiple streams; fulfills
        // each
        // request from first stream, then moves on to the second one
        // ** PrintStream --> provides output capabilities from the System file handle,
        // System.out
        // ** DataInputStream & DataOutputStream --> enables to write or read primitive
        ...
        // ** ObjectInputStream & ObjectOutputStream --> for object serialization (see
        ...
        // FilterInputStream & FilterOutputStream --> wrappers around underlying input
        // and output streams providing extended level of functionality; no new methods

        // BufferedInputStream & BufferedOutputStream --> allow to read and write bigger
        // chunks of data (not only single bytes); good for optimization
        exampleStr = "This is a &copy; copyright symbol but this is &copy not.\n";
        byteArr = exampleStr.getBytes();
        Boolean marked = false;

        try (BufferedInputStream bufferedInputStream = new BufferedInputStream(new ByteArrayInputStream(byteArr));
                ...
                switch (c) {
                    case '=':
                        if ((c = pushbackInputStream.read()) == '=') {
                            ...
                            System.out.print("<-");
                            pushbackInputStream.unread(c); // unread allows to "return" the byte (or array of bytes)
                                                           // back to the PushbackInputStream
                        }
                        break;
                    default:
                        System.out.print((char) c);
        ...
        // SequenceInputStream --> allows to concatenate multiple streams; fulfills each
        // request from first stream, then moves on to the second one
        SequenceInputStream sequenceInputStream = new SequenceInputStream(new ByteArrayInputStream(byteArr),
        ...
        // DataInputStream & DataOutputStream --> enable to write or read primitive data
        // to or from a stream
        ...
        // BufferedReader & BufferedWriter --> same as in BufferedInputStream &
